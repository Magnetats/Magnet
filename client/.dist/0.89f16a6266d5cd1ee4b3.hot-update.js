...
var LeftNav = function (_Component) {
  ...
  _createClass(LeftNav, [{
    ...
    value: function render() {
      ...
      })(['#side-user-pic{min-width:6em;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;color:#fff;border-radius:0.28571429rem 0.28571429rem 0 0;border-radius:0 !important;background:0 0;color:rgba(255,255,255,0.9);height:auto;text-align:center;color:#1b1c1d;display:block;background:0 0;border-top:none;border-right:none;padding:16px;&:hover{color:', ';}}&&&&{width:0%;min-width:120px;margin-left:2.4%;top:59px;background-color:#fff;position:relative;margin-top:21px;border-radius:5px 5px 5px 5px;-webkit-box-shadow:17px 25px 94px -10px rgba(48,72,97,1);-moz-box-shadow:17px 25px 94px -10px rgba(48,72,97,1);box-shadow:17px 25px 94px -10px rgba(48,72,97,1);}'], __WEBPACK_IMPORTED_MODULE_5__styling_theme_variables__["d" /* medBlue */]);
