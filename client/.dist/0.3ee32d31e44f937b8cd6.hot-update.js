...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__styling_theme_variables_js__ = __webpack_require__("./client/src/styling/theme/variables.js");
...
var LeftNav = function (_Component) {
  ...
  _createClass(LeftNav, [{
    ...
    value: function render() {
      ...
      })(['#side-user-pic{min-width:6em;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;color:#fff;border-radius:0.28571429rem 0.28571429rem 0 0;border-radius:0 !important;background:0 0;color:rgba(255,255,255,0.9);height:auto;text-align:center;color:#1b1c1d;display:block;background:0 0;border-top:none;border-right:none;padding:16px;}&&&&{width:0%;min-width:120px;margin-left:2.4%;top:59px;background-color:#fff;position:relative;margin-top:21px;-webkit-box-shadow:17px 25px 94px -10px rgba(48,72,97,1);-moz-box-shadow:17px 25px 94px -10px rgba(48,72,97,1);box-shadow:17px 25px 94px -10px rgba(48,72,97,1);}']);
      ...
      })(['&&&&&&{&.active{background-color:white !important;font-size:104%;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;&:after{height:18px;width:18px;background-color:white !important;&:hover{height:18px;width:18px;background-color:white !important;}}}background-color:', ' !important;font-weight:600;&:hover{font-size:104%;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;}}'], __WEBPACK_IMPORTED_MODULE_5__styling_theme_variables_js__["d" /* medBlue */]);
      ...
      })(['color:gray !important;font-weight:600;&:hover{font-size:102%;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;}}']);
      ...
      return __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(
          ...
          (_React$createElement = {
            ...
            icon: 'labeled' }, _defineProperty(_React$createElement, 'vertical', true), _defineProperty(_React$createElement, 'inverted', true), _defineProperty(_React$createElement, 'className', 'side-nav-background'), _React$createElement),
          __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(
            LeftNavMenuItem,
            {
              name: 'user pic',
