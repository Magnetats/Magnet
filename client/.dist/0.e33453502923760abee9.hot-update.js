...
var LeftNav = function (_Component) {
  ...
  _createClass(LeftNav, [{
    ...
    value: function render() {
      ...
      })(['&&&&&&{color:#f0f0f0;background-color:', ' !important;font-weight:400;&:last-child{border-radius:0px 0px 5px 5px;}&.active{font-size:104%;font-weight:900;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;.left-nav-icons{background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;}&:after{-webkit-box-shadow:inset -4px 8px 7px -7px rgba(255,255,255,1);-moz-box-shadow:inset -4px 8px 7px -7px rgba(255,255,255,1);box-shadow:inset -4px 8px 7px -7px rgba(255,255,255,1);&:hover{height:18px;width:18px;background-color:white !important;}}&:before{-webkit-box-shadow:inset -4px 8px 7px -7px rgba(255,255,255,1);-moz-box-shadow:inset -4px 8px 7px -7px rgba(255,255,255,1);box-shadow:inset -4px 8px 7px -7px rgba(255,255,255,1);}}&:hover{&:after{height:18px;width:18px;background-color:white !important;}background-color:#ffffff !important;font-size:104%;font-weight:900;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;.left-nav-icons{background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;}}}'], __WEBPACK_IMPORTED_MODULE_5__styling_theme_variables__["d" /* medBlue */]);
