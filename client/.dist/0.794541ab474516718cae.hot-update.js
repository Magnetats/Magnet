...
var LeftNav = function (_Component) {
  ...
  _createClass(LeftNav, [{
    ...
    value: function render() {
      ...
      })(['&&&&&&{&.active{background-color:white !important;font-size:104%;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;&:after{height:18px;width:18px;background-color:white !important;&:hover{height:18px;width:18px;background-color:white !important;}}}background-color:', ' !important;font-weight:500;border-radius:5px 5px 5px 5px;&:last-child{border-radius:0px 0px 5px 5px;}&:hover{font-size:104%;background-color:#565656 !important;color:transparent !important;text-shadow:2px 2px 3px rgba(255,255,255,0.5);-webkit-background-clip:text;-moz-background-clip:text;background-clip:text;}}'], __WEBPACK_IMPORTED_MODULE_5__styling_theme_variables__["d" /* medBlue */]);
